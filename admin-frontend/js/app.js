            ...
            const modalContent = `
                <form id="create-activity-form">
                    <div class="form-group">
                        ...
                        <select id="create-team-id" name="team_id" required class="form-control">
                    ...
                    <div class="form-group">
                        ...
                        <select id="create-type" name="type" required class="form-control">
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            ...
                            <input type="datetime-local" id="create-start-time" name="start_time" required class="form-control">
                        </div>
                        <div class="form-group col-md-6">
                            <label for="create-end-time">结束时间 *</label>
                            <input type="datetime-local" id="create-end-time" name="end_time" required class="form-control">
                        </div>
                    </div>
